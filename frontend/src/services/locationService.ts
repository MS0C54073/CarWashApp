 ...
 * Also provides browser geolocation utilities
 */
...
/**
 * Format distance for display (re-export from mappingService for convenience)
 */
export { formatDistance } from './mappingService';
