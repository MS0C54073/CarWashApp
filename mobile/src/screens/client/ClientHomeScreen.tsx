    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.menu}>
        ...
        >
          ...
          <Text style={styles.menuItemSubtext}>Book a car wash pickup</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuItemSubtext}>View all your bookings</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuItemSubtext}>Manage your vehicles</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
